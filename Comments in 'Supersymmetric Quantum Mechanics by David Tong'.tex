...
\switchcolumn
正如我们在第 1.4.1 节中已经宣传的那样，这是几何中非常熟悉的结构：它出现于完全反对称的 $(0, p)$ 张量场，也称为 \textit{p-forms}。这会提示识别
\switchcolumn*
...
We also need to ﬁgure out what’s going on with fermions. This is the same calculation that we already met in Section 1.4.1. There, we learned that we should look at the eigenvalues of the Hessian $\pdv{h}!{i, j} $,
