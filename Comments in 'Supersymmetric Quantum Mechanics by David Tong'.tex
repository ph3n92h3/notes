...
The canonical example of a non-spin 4-manifold is complex projective space $\mathbf{CP}^2$. It’s not possible to consistently patch spinor ﬁelds over this space, and so the question of counting solutions to the Dirac equation is irrelevant. It turns out that $p_1(\mathbf{CP}^2) = 3$. Moreover, one can show that for any orientable 4-manifold, $p_1$ is always divisible by 3.
\switchcolumn
